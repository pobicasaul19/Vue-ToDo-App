    ...
    <fieldset>
      ...
      >
        ...
        <div class="input_container">
          <label class="input_label" for="registerData.name">Name</label>
          <svg
            height="24"
            width="24"
          ...
          <input
            type="text"
            class="input_field"
            id="registerData.name"
            autocomplete="name"
            v-model="registerData.name"
          />
        </div>
        <div class="input_container">
          <label class="input_label" for="registerData.email">Email</label>
          <svg
            fill="none"
            viewBox="0 0 24 24"
            height="24"
        ...
        <div class="input_container">
          <label class="input_label" for="registerData.password"
            >Password</label
          >
          <svg
            fill="none"
